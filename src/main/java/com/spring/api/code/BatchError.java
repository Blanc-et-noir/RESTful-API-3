...
public enum BatchError implements Code{
	...
	ORDER_NOT_MATCHED_TO_REGEX("BATCH_004","배치 조회 정렬 기준이 형식에 맞지 않음",HttpStatus.BAD_REQUEST),
	LIMIT_OUT_OF_RANGE("BATCH_005","배치 작업 조회 크기가 범위를 벗어남",HttpStatus.BAD_REQUEST),
	NOT_FOUND_JOB_EXECUTION("BATCH_006","배치 작업 정보 없음",HttpStatus.BAD_REQUEST);
