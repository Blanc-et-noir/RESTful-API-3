...
public enum UserError implements Code{
	...
	QUESTION_ANSWER_EXCEED_MAX_BYTES("USER_10007","비밀번호 찾기 질문의 답이 허용 크기를 초과함", HttpStatus.BAD_REQUEST),
	...
	INVALID_QUESTION_ID("USER_10011","유효하지 않은 비밀번호 찾기 질문 ID",HttpStatus.BAD_REQUEST),
